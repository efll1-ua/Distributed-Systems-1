...
public class ThreadKafkaPing extends Thread{
	private ThreadLeerMapa threadMapa;
	private ThreadPing threadPing;
	private final AdminClient client;
	public ThreadKafkaPing(ThreadLeerMapa threadMapa, ThreadPing threadPing) {
	...
	public void run() {
		...
		while(!parar) {
			try {
				...
				parar = true;
				this.threadMapa.parar();
				this.threadPing.setParar(true);
				System.exit(-1);
